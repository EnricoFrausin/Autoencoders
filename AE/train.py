...
def train(model, train_loader, val_loader, optimizer, writer, epochs, save_tensorboard_parameters=False):
    ...
    for epoch in range(epochs):
        ...
        writer.add_scalar('Loss/val', val_loss / len(val_loader.dataset), global_step=epoch)
    ...
    writer.close()
    print(f'Training completed. Final training loss: {train_loss / len(train_loader.dataset)}, Validation loss: {val_loss / len(val_loader.dataset)}')
